...
output_dir="output/estimation/ezgolf/2024-04-17_17-47-34/result_v"

image_and_camera_param="xrmocap_data/panoptic/image_and_videos/dance2a/image_and_camera_param.txt"
output_dir="output/estimation/panoptic/dance2a/result_i"

python tools/mview_mperson_smpl_estimator.py \
	--estimator_config 'configs/golfpose/mview_mperson_smpl_estimator.py' \
