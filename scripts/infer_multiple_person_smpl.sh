...
#image_and_camera_param="xrmocap_data/ezgolf/golf_20240628/image_and_videos/2024-06-28_17-41-31/image_and_camera_param.txt"
#output_dir="output/estimation/ezgolf/2024-06-28_17-41-31/result_vs"

image_and_camera_param="xrmocap_data/ezgolf/golf_simulation/image_and_videos/2024-07-23_10-56-09/image_and_camera_param.txt"
output_dir="output/estimation/ezgolf/2024-07-23_10-56-09/result_vs"

python tools/mview_mperson_smpl_estimator.py \
	--estimator_config 'configs/golfpose/mview_mperson_smpl_estimator_m.py' \
